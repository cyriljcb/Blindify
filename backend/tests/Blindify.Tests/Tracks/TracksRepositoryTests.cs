...
public class TracksRepositoryTests : IDisposable
{
    ...
    {
        var options = Options.Create(new DataPathsOptions { TracksPath = _tracksPath, StatsPath = "unused", FlagsPath = "unused", FlagsResolutionsPath = "unused", RootPath = "unused" });
    ...
    {
        var options = Options.Create(new DataPathsOptions { TracksPath = Path.Combine(Path.GetTempPath(), "inexistant.json"), StatsPath = "unused", FlagsPath = "unused", FlagsResolutionsPath = "unused", RootPath = "unused" });
